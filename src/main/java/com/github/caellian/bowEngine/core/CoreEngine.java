...
import com.github.caellian.bowEngine.core.util.Time;
import com.github.caellian.bowEngine.core.util.input.InputHelper;
import com.github.caellian.bowEngine.physics.PhysicsEngine;
	...
	private void run()
	{
		...
		while (isRunning)
		{
			...
			while (unprocessedTime > frameTime)
			{
				...
				physicsEngine.preUpdate(game.getRoot());
			...
			physicsEngine.postUpdate(game.getRoot());
		}
