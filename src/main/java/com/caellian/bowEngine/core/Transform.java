...
import com.caellian.bowEngine.core.math.Quaternion;
...
public class Transform
{
	...
	protected void setTransformDefaults() {
	...
	public Quaternion getRotationVelocity() {
		return rotationVelocity;
	}

	public void setRotationVelocity(Quaternion rotationVelocity) {
